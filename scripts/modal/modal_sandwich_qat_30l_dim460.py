"""
Sandwich MLP + QAT 30L dim=460 Experiment
===========================================

30L Sandwich QAT with dim=460 (max ~16MB with FP16 embedding) and 40k steps.

## Run
```bash
modal run --detach scripts/modal/modal_sandwich_qat_30l_dim460.py
```
...
app = modal.App("sandwich-qat-30l-dim460")
